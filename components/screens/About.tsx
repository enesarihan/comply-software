...
export default function AboutSection() {
  ...
  return (
    <section 
      id="about" 
      className="relative pt-8 pb-16 px-4 overflow-hidden bg-gradient-to-br from-teal-50 via-emerald-50 to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900"
    >
      ...
      {/* Seamless transition to Services section */}
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-b from-transparent via-blue-50/50 to-indigo-50 dark:via-gray-950/50 dark:to-gray-900"></div>
    </section>
  );
}
